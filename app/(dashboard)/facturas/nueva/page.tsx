...
import {
  ArrowLeft, ArrowRight, CheckCircle, RotateCcw, Plus,
...
export default function NuevaFacturaPage() {
  ...
  async function handleFileReady(file: File | null) {
    ...
    try {
      ...
      // Si falla la extracción, seguimos igual al formulario manual
    }
      ...
      <div className="max-w-2xl mx-auto space-y-6">
          ...
          <div className="rounded-3xl border bg-card p-10 text-center space-y-5">
            ...
            <div>
              ...
              <p className="text-muted-foreground text-sm mt-1">
                Extrayendo proveedor, importes, IVA y fecha.
              </p>
            </div>
          </div>
        )}
        ...
        {step === "review" && (
          <div className={`grid gap-6 ${isImage && imagePreview ? "lg:grid-cols-2" : "grid-cols-1"}`}>
            ...
            {/* Vista previa imagen (solo si es foto) */}
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              <div className="rounded-2xl border bg-card p-5 space-y-4">
                  ...
                  <div className="flex gap-2">
                    ...
                    >
                      <SelectTrigger className="flex-1">
                        <SelectValue placeholder="Selecciona o crea el proveedor..." />
                      </SelectTrigger>
                      <SelectContent>
                        {suppliers.map((s) => (
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div className="space-y-1.5">
                    <Label>IVA *</Label>
                    <Select value={String(vatRate)} onValueChange={(v) => { if (v) setValue("vat_rate", parseFloat(v as string)) }}>
